...
\advisor{\\\vspace{0.25cm}Msc. Fernando Raúl Rodríguez Flores\\\vspace{0.2cm}Nombre del segundo tutor}
\degree{Licenciado en Ciencia de la Computación}
\faculty{Facultad de Matemática y Computación}
\date{Mayo, 2026\\\vspace{0.25cm}\href{https://github.com/noelpc03/Tesis}{github.com/noelpc03/Tesis}}
