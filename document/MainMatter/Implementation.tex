...
\section{Diseño experimental} \label{sec:diseno_comun}
...
\section{Comparación de funciones de pérdida con ecuaciones individuales} \label{sec:fase1}
...
\subsection{Ecuaciones de prueba}
...
\subsection{Funciones de pérdida evaluadas}
...
\section{Extensión a sistemas de ecuaciones} \label{sec:fase2}
...
\subsection{Sistemas de prueba} \label{sec:sistemas_prueba_fase2}
...
\multicolumn{3}{r}{\textit{}} \\
\endfoot \hline \endlastfoot
S01 & \(\left\{\begin{array}{rcl} x + y - a &=& 0 \\ x - y - b &=& 0 \end{array}\right.\) &
...
\subsection{Configuración específica}
...
\subsection{Resultados} \label{sec:resultados_fase2}
...
\subsection{Análisis} \label{sec:analisis_fase2}
...
\section{Consideraciones finales} \label{sec:conclusiones_capitulo}
