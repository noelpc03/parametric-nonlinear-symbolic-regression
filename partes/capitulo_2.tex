...
\subsection{Planteamiento general del problema} \label{sec:planteamiento}
...
\subsection{Generación de datos de entrenamiento} \label{sec:generacion_datos}
...
\subsection{Estrategia de regresión simbólica} \label{sec:estrategia_sr}
...
\subsubsection{Separación por coordenadas} \label{sec:desacoplamiento}
...
\subsubsection{Búsqueda iterativa sobre \(x_1\)} \label{sec:busqueda_ancla}
...
\subsubsection{Extensión a las demás coordenadas} \label{sec:extension_coordenadas}
...
\subsubsection{Validación de una solución completa} \label{sec:validacion_solucion}
