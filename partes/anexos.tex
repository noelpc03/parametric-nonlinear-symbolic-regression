...
\title{Anexo: Detalles de implementación} \author{Noel Pérez Calvo} \date{\today}

\begin{document}

\maketitle

\section*{Anexo: Detalles de implementación} \label{sec:anexo_implementacion}
...
\subsection{Descripción de los módulos} \label{sec:modulos_anexo}
...
\subsection{Entradas, parámetros y salidas del sistema} \label{sec:entradas_salidas_anexo}
